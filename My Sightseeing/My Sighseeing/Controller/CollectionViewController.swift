...
class CollectionViewController: UIViewController {
    ...
    {
        let request = APIRequest(lat: latitude, lon: longitude, format: "json", action: "query", generator: "geosearch", ggsprimary: "all", ggsnamespace: "6", ggsradius: "1000", ggslimit: "10", prop: "imageinfo", iilimit: "10", iiprop: "url", iiurlwidth: "200", iiurlheight: "200")
        
        var responseArray = [url]()
        
        WikiClient.getPhotos(body: request) { (response, error) in
    ...
    func addImageToContext(photos: [url], pin: Pin)
    {
